	...
	function update() {
		...
		for (let i = 0; i < objets.length; i++) {
			if (objets[i].x > window.innerWidth + 50) {
				...
				if (
					(wtop > otop && wtop < obottom) ||
					(otop > wtop && otop < wbottom)
				) {
					v = true;
				}
				if (
					(wright < oright && wright > oleft) ||
					(oright < wright && oright > wleft)
				) {
					h = true;
				}
...
{:else}
	<div class="game">
		...
		<h1>{score}</h1>
		<img
			src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww3.nd.edu%2F~ljordan%2Flinux%2Fimages%2Ftuxwhitebg.jpg&f=1&nofb=1&ipt=82e9c2c669df3b3198f68402d7d17830b11aec84ee12bae4f15a6e16f5c7be04&ipo=images"
			alt="Tux"
			class="tux"
		/>

		<img
			src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Flogospng.org%2Fdownload%2Fwindows-11%2Flogo-windows-11-icon-512.png&f=1&nofb=1&ipt=30fd6dbbc43d95d8d1a7fa1663c6bf5caaa9b4fcfa049f6af7d82ce62713ef1b&ipo=images"
